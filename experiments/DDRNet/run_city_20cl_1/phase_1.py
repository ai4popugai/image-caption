"""The same as run_city_20cl_0, but with CrossEntropyLoss with ignore_index=0"""
...
from datasets.segmantation.cityscapes import CityscapesDataset20
...
class Phase(RunBase):
    ...
    def setup_datasets(self) -> Tuple[Dataset, Dataset]:
        train_dataset, val_dataset = CityscapesDataset20(split='train'), \
                                     CityscapesDataset20(split='val')
    ...
    def get_batch_sample_to_image_map(self) -> Dict[str, BaseToImageTransforms]:
        return {FRAME_KEY: FramesToImage(),
                GROUND_TRUTH_KEY: GroundTruthToImage(color_map=CityscapesDataset20.color_map),
                LOGIT_KEY: LogitsToImage(color_map=CityscapesDataset20.color_map)}
